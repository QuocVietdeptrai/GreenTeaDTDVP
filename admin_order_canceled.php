...
<link rel ="stylesheet" type = "text/css" href="backend.css?v=<?php echo time(); ?>">
    ...
    <title>GREEN-TEA order canceled</title>
</head>
<body>
        ...
        <section class = "order-container">
            ...
            <div class = "box-container">
                <?php
                    ...
                    where status in ( 'canceled-kh' , 'canceled-nv')
                ...
                $select_orders->execute();
                    ...
                    <div class="box">
                        ...
                        <?php 
                        if ($fetch_orders['status'] == 'delivered') { echo "green"; }
                        else if ($fetch_orders['status'] == 'in progress') { echo "blue"; }
                        else if ($fetch_orders['status'] == 'canceled-nv') { echo "red"; }
                        else if ($fetch_orders['status'] == 'canceled-kh') { echo "brown"; }
                        else { echo 'orange'; } ?>">
                        <?= $fetch_orders['status']; ?>
                        </div>
                        <div class="detail">
