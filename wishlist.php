        ...
        <section class="products">
            ...
            <div class="box-container">
                ...
                <?php
                            ...
                            // Xóa sản phẩm khỏi danh sách yêu thích nếu không còn hoạt động
                            $delete_inactive_wishlist = $conn->prepare("DELETE FROM `wishlist` WHERE id = ?");
                            $delete_inactive_wishlist->execute([$fetch_wishlist['id']]);
                        }
                    }
                } else {
                    echo '<p class="empty">Chưa có sản phẩm nào thêm vào danh sách yêu thích.</p>';
                }
                ?>
            </div>
